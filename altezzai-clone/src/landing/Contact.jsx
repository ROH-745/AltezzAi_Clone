...
function Contact() {
  ...
  return (
    <section className="bg-[#f3f3f3] py-3 lg:py-4">
      <div className="max-w-7xl mx-auto px-8 sm:px-6 lg:px-3">
       
        <h2
          className="text-4xl lg:text-5xl font-medium text-gray-900 mb-8 lg:mb-10"
            ...
            <div className="relative max-w-xs lg:max-w-sm w-full">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex justify-center">
                {/* <button
                  ...
                  className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 rounded-full flex items-center gap-2 shadow-lg transition-colors duration-300"
                  style={{ fontFamily: "Space Grotesk" }}
                > */}
                {/* <button onClick={handleEmailClick} className="flex items-center gap-2 px-6 py-3 rounded-full bg-teal-600 text-white shadow-lg transition-all duration-400 ease-in-out hover:bg-[#40646b] hover:-translate-y-[2px]" style={{ fontFamily: 'Space Grotesk' }}> */}
                <button
                    onClick={handleEmailClick}
          ...
          <div className="w-full lg:w-1/2 lg:ml-16">
            <div className="bg-gray-50 rounded-3xl pt-3 px-3 pb-6 lg:pt-5 lg:px-5 lg:pb-8">
              ...
              <form className="space-y-3 mt-4">
                ...
                <button
                  type="submit"
                  className=" w-full bg-[#2e9eb9] hover:bg-teal-700 text-white py-3 px-6 rounded-xl font-medium transition-colors duration-300"
                  style={{ fontFamily: "Space Grotesk" }}
                >
                  Send Message
                </button>
